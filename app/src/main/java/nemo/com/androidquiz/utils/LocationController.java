...
public class LocationController implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void callPermissionUI() {
        if (!checkPermission(Manifest.permission.ACCESS_FINE_LOCATION)){
            ActivityCompat.requestPermissions((Activity)context, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, AppConstant.PERMISSION_LOCATION);
        } else{
            loadLocationService();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        switch (requestCode) {
            case AppConstant.PERMISSION_LOCATION:
                loadLocationService();
            default:
                break;
        }
